...
const AdminAdvertisers: React.FC = () => {
    ...
    const fetchAdvertisers = async () => {
        setIsLoading(true);
        try {
            // This is a simplified fetch, normally we'd have an advertisers collection
            const q = query(collection(db, 'advertisers'), orderBy('name', 'asc'));
        ...
        <div className="min-h-screen bg-[#02020a] text-white flex">
            ...
            <aside className="fixed left-0 top-0 h-full w-64 bg-[#050510] border-r border-white/5 p-6 flex flex-col z-50">
                ...
                <nav className="flex-1 space-y-2">
                    ...
                    <button onClick={() => navigate('/admin/advertisers')} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl bg-violet-600 text-white shadow-lg shadow-violet-900/20">
                        <Users size={18} />
