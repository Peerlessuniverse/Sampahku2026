    ...
    methods: [
      ...
      },
      {
        ...
        fullDetail: {
          ...
          steps: [
            { title: 'Lubang Tanam', desc: 'Gali lubang kecil di pinggir pot tanaman yang sedang tumbuh.' },
            { title: 'Kubur Sampah', desc: 'Masukkan sisa dapur organik ke dalam lubang tersebut.' },
            { title: 'Penutupan', desc: 'Tutup kembali dengan tanah agar tidak mengundang lalat.' },
      ...
      },
      {
        ...
        fullDetail: {
          ...
          steps: [
            { title: 'Pelubangan', desc: 'Buat lubang sedalam 1 meter dengan diameter 10-30 cm.' },
            { title: 'Pemasangan Pipa', desc: 'Masukkan pipa PVC yang sudah dilubangi ke dalam tanah.' },
            { title: 'Isi Sampah', desc: 'Masukkan sampah organik ke dalam pipa hingga penuh.' },
      ...
      },
      {
        ...
        fullDetail: {
          ...
          steps: [
            { title: 'Input Sampah', desc: 'Masukkan cacahan sampah organik kasar ke dalam bak bata.' },
            { title: 'Aerasi Alami', desc: 'Udara masuk melalui celah bata tanpa perlu pengadukan sering.' },
            { title: 'Penyemprotan', desc: 'Semprot dengan MOL setiap 3 hari sekali untuk kelembapan.' },
      ...
      },
      {
        ...
        fullDetail: {
          ...
          steps: [
            { title: 'Perbandingan', desc: 'Gunakan rumus 1:3:10 (Gula:Sampah:Air).' },
            { title: 'Pencampuran', desc: 'Larutkan gula dalam air, masukkan cacahan kulit buah segar.' },
            { title: 'Fermentasi', desc: 'Simpan selama 3 bulan di tempat teduh.' },
    ...
    methods: [
      ...
      },
      {
        ...
        fullDetail: {
          ...
          steps: [
            { title: 'Pemilahan', desc: 'Pilah sampah berdasarkan kategori (Plastik, Kertas, Kaleng, Kaca). Pastikan dalam kondisi bersih.' },
            { title: 'Dropping & Timbang', desc: 'Bawa sampah ke lokasi Bank Sampah terdekat. Petugas akan menimbang sesuai kategori.' },
            { title: 'Pencatatan Tabungan', desc: 'Hasil timbangan dikonversi ke rupiah dan dicatat dalam buku tabungan nasabah.' },
      ...
      },
      {
        ...
        fullDetail: {
          ...
          steps: [
            { title: 'Pilih & Bersihkan', desc: 'Pilih sachet dengan motif menarik, cuci bersih, dan keringkan.' },
            { title: 'Pembuatan Pola', desc: 'Potong bahan sesuai desain tas atau dompet yang diinginkan.' },
            { title: 'Anyaman/Jahit', desc: 'Anyam sachet atau jahit paku bersama kain pelapis agar lebih kuat.' },
      ...
      },
      {
        ...
        fullDetail: {
          ...
          steps: [
            { title: 'Sortir Polimer', desc: 'Pisahkan plastik berdasarkan jenisnya (PET, HDPE, PP) agar tidak tercampur.' },
            { title: 'Penghilangan Label', desc: 'Lepaskan label dan lem yang menempel pada permukaan plastik.' },
            { title: 'Proses Shredding', desc: 'Masukkan plastik ke mesin pencacah hingga menjadi flakes berukuran seragam.' },
    ...
    methods: [
      {
        ...
        fullDetail: {
          ...
          steps: [
            { title: 'Drop Off', desc: 'Identifikasi perangkat elektronik yang sudah tidak berfungsi dan masukkan ke dropbox resmi.' },
            { title: 'Sortir Tenaga Ahli', desc: 'Perangkat dibawa ke fasilitas pemurnian untuk dibongkar secara hati-hati.' },
            { title: 'Ekstraksi Komponen', desc: 'Pemisahan material berharga (emas, perak, tembaga) dari sirkuit elektronik.' },
      ...
      },
      {
        ...
        fullDetail: {
          ...
          steps: [
            { title: 'Penyaringan', desc: 'Saring minyak jelantah dari sisa makanan atau kotoran padat.' },
            { title: 'Penampungan', desc: 'Simpan minyak dalam jerigen tertutup. Hindari mencampur dengan air.' },
            { title: 'Pengiriman ke Depot', desc: 'Setorkan minyak ke titik pengumpulan yang bekerja sama dengan pabrik biodiesel.' },
      ...
      },
      {
        ...
        fullDetail: {
          ...
          steps: [
            { title: 'Segregasi', desc: 'Pisahkan limbah medis berdasarkan jenis (tajam, infeksius, kimia).' },
            { title: 'Inaktivasi Virus', desc: 'Proses sterilisasi menggunakan uap panas bertekanan tinggi untuk membunuh patogen.' },
            { title: 'Penghancuran Mekanis', desc: 'Limbah yang sudah steril dicacah agar tidak dapat digunakan kembali.' },
      ...
      },
      {
        ...
        fullDetail: {
          ...
          steps: [
            { title: 'Pembebanan Kosong', desc: 'Pastikan baterai benar-benar kosong dari energi listrik untuk mencegah ledakan.' },
            { title: 'Crushing Berpendingin', desc: 'Proses pelumatan baterai dalam lingkungan nitrogen atau argon.' },
            { title: 'Hidrometalurgi', desc: 'Penggunaan larutan asam untuk memisahkan kobalt, nikel, dan lithium.' },
    ...
    methods: [
      {
        ...
        fullDetail: {
          ...
          steps: [
            { title: 'Pengurangan Kadar Air', desc: 'Sampah residu dikeringkan hingga kadar air di bawah 20%.' },
            { title: 'Pencacahan Halus', desc: 'Material dipotong menjadi serpihan kecil agar mudah dipadatkan.' },
            { title: 'Pemadatan (Pelletizing)', desc: 'Sampah ditekan menjadi pelet silindris padat berkalori tinggi.' },
      ...
      },
      {
        ...
        fullDetail: {
          ...
          steps: [
            { title: 'Pelapisan Dasar', desc: 'Pemasangan lapisan kedap air (Geomembran) di dasar landfill.' },
            { title: 'Penghamparan Sampah', desc: 'Sampah ditumpuk dan dipadatkan menggunakan alat berat.' },
            { title: 'Penutupan Harian', desc: 'Lapisan sampah ditutup dengan tanah setiap hari untuk mencegah bau dan lalat.' },
      ...
      },
      {
        ...
        fullDetail: {
          ...
          steps: [
            { title: 'Pemasangan Sumur Gas', desc: 'Menanam pipa-pipa berlubang ke dalam gunungan sampah yang sudah stabil.' },
            { title: 'Penyedotan Gas', desc: 'Gas metana ditarik menggunakan alat penghisap (blower).' },
            { title: 'Pemurnian', desc: 'Gas dipisahkan dari uap air dan partikel lain agar aman untuk mesin.' },
      ...
      },
      {
        ...
        fullDetail: {
          ...
          steps: [
            { title: 'Thermal Oxidation', desc: 'Membakar sampah hingga habis menjadi abu (Residual Ash) dan panas.' },
            { title: 'Energy Recovery', desc: 'Panas yang dihasilkan digunakan untuk mendidihkan air menjadi uap turbin.' },
            { title: 'Flue Gas Cleaning', desc: 'Asap hasil pembakaran disaring melalui berbagai filter kimiawi agar bersih.' },
...
const SponsorTransition: React.FC<{ onComplete: () => void, sponsor: any }> = ({ onComplete, sponsor }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-[#022c22] flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full text-center space-y-8 animate-in fade-in zoom-in duration-500">
        <div className="space-y-2">
          <span className="text-emerald-400 font-black uppercase tracking-[0.3em] text-[10px]">Information brought to you by</span>
          <h2 className="text-4xl font-black text-white italic uppercase">{sponsor.name}</h2>
        </div>
        ...
        <div className="relative aspect-video w-full rounded-2xl overflow-hidden bg-white/5 border border-white/10 flex items-center justify-center">
          ...
          {sponsor.mediaUrl ? (
            ...
            <div className="p-8">
              <Sparkles className="w-12 h-12 text-[#4ade80] mx-auto mb-4 animate-pulse" />
              <p className="text-white font-bold italic uppercase">{sponsor.message}</p>
            </div>
          )}
        </div>
        ...
        <div className="space-y-4">
          <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
            <div
              className="h-full bg-[#4ade80] transition-all duration-100 ease-out"
              style={{ width: `${progress}%` }}
            ></div>
          </div>
          <p className="text-white/30 font-black uppercase text-[10px] tracking-widest">Memuat tutorial eksklusif...</p>
        </div>
      </div>
    </div>
  );
