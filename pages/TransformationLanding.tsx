      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 max-w-6xl mx-auto">
          {categories.map((item) => (
            <div
              ...
              className="group cursor-pointer flex flex-col items-center text-center space-y-8"
            >
        ...
        <div className="mt-24 text-center max-w-3xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom duration-1000 px-6 pb-12">
          ...
          <div className="flex flex-col items-center">
            <Link
              to="#"
              className="inline-flex items-center gap-4 bg-white text-[#022c22] font-black px-10 py-5 rounded-[2rem] hover:scale-105 transition-all shadow-[0_20px_60px_rgba(74,222,128,0.1)] uppercase tracking-tighter text-xl italic group"
            >
